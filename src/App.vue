    ...
    <el-container>
      ...
      <div class="topbar" v-show="$route.meta.showMenu!==false">
        <div class="nav">
          <ul>
            ...
            <li class="font">
              <router-link to="/favorite">项目管理</router-link>
            </li>
            <li class="font">
      ...
      <el-header v-show="$route.meta.showMenu!==false">
        ...
        >
          ...
          <el-menu-item index="/goods">探索项目</el-menu-item>
          <el-menu-item index="/goods">发布项目</el-menu-item>
          <el-menu-item index="/about/us01">关于我们</el-menu-item>
          <div class="so">
        ...
        <div class="footer">
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                <a class="icon1" href="javascript:;">我们是为了社会事业</a>
                <a class="icon2" href="javascript:;">我们为您保留您所筹集所有的100％</a>
                <a class="icon3" style="margin-right: 0" href="javascript:;">我们追求收费透明</a>
              </p>
            </div>
          </div>
          <div class="github">
